Shader "Code Repository/Scene/CustomTerrain"
{
    Properties
    {
    ...
    SubShader
    {
		...
		Pass 
		{
			...
			VaryingsBakeHeight BakeHeightVertex(AttributesBakeHeight v)
			{
                VaryingsBakeHeight o = (VaryingsBakeHeight)0;
			...
			half4 BakeHeightFragment(VaryingsBakeHeight IN) : SV_TARGET
			{
                #ifdef _ALPHATEST_ON
	                ClipHoles(IN.texcoord);
                #endif
				return PackHeightmapR(IN.positionWS);
			}
