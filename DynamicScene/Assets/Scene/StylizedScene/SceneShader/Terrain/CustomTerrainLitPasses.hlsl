...
#endif
{
    ...
    half puddleMask = 1.0 - splatControl.a;
    splatControl.a = 0.0;
    ...
    half4 defaultHeight = 1.0;
    defaultHeight = lerp(defaultHeight, maskHeight, hasMask);
    half height = dot(splatControl, defaultHeight);
#endif
    ...
    WetData wetData;
    half3x3 tTOw = half3x3(IN.tangent.xyz, IN.bitangent.xyz, IN.normal.xyz);
    InitializeWetData(height, half4(0.0, puddleMask, 1.0, 0.0), IN.positionWS, tTOw, wetData);

    half4 color = FragmentCustomPBR(inputData, wetData, albedo, metallic, /* specular */ half3(0.0h, 0.0h, 0.0h), smoothness, occlusion, /* emission */ half3(0, 0, 0), alpha);
